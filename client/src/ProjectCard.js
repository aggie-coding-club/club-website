  ...
  componentWillMount(){
    try{
      ...
      if (this.props.repo !== 0){
        if (this.props.repo[0].languages) this.establishLanguage();
        if (this.props.repo[0].html_url) this.setState({githubLink: this.props.repo[0].html_url});
        if (this.props.repo[0].description){
